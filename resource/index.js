...
/***/ function(module, exports, __webpack_require__) {
	...
	var comps = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\git_resp\\vue-demo\\src\\components\\header.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\compB.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\git_resp\\vue-demo\\src\\components\\compB.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./compB.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./compB.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compA = __webpack_require__(49);

	var $ = __webpack_require__(53);
	var magnific = __webpack_require__(55);

	$(document).ready(function () {
	    $('.img-pop a').magnificPopup({
	        type: 'image'
	    });

	    $('.text-pop a').magnificPopup({
	        type: 'inline'
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\compA.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\git_resp\\vue-demo\\src\\components\\compA.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2ef801a0&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./compA.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2ef801a0&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./compA.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.compA[_v-2ef801a0] {\n    margin: 10px 0;\n    background: yellow;\n    background-image: -webkit-linear-gradient(hsl(0, 80%, 70%), #bada55);/* For Chrome 25 and Safari 6, iOS 6.1, Android 4.3 */  /* For Firefox (3.6 to 15) */\n    background-image: -webkit-linear-gradient(top, hsl(0, 80%, 70%), #bada55);\n    background-image: linear-gradient(to bottom, hsl(0, 80%, 70%), #bada55); /* Standard syntax; must be last */\n}\n.ip[_v-2ef801a0] {\n    width: 400px;\n    height: 30px;\n    border-radius: 4px;\n}\nh2[_v-2ef801a0] {\n    color: #000;\n}\nh2[_v-2ef801a0]:hover {\n    color: #fff;\n    background-color: #000;\n}\n", ""]);
